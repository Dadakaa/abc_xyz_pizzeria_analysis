...
Данные пиццы **формируют основу продаж** пиццерии и демонстрируют высокий и стабильный спрос. Именно эта группа обеспечивает значительную часть выручки компании и **должна оставаться в центре маркетинговой и продуктовой стратегии.**
- Thai Chicken
- Barbecue Chicken
- California Chicken
- Classic Deluxe
...
- использование механик апсейла и кросс-продаж (напитки, закуски, десерты)
- включение в комбо-наборы
- размещение в блоках «Популярное» и «Хиты продаж»
- приоритетное отображение в мобильном приложении и на сайте
- использование наиболее успешных сочетаний ингредиентов данной группы при разработке новых продуктов
- обеспечение постоянного наличия ингредиентов и минимизация риска отсутствия данных позиций в продаже

Отдельно стоит отметить высокий спрос на пиццы с курицей: сразу несколько таких позиций входят в число лидеров продаж. Это может указывать на перспективность дальнейшего развития данного направления меню.


<h4 align="center">Высокодоходные пиццы с переменным спросом (AAY / AAZ)</h4>

Данные пиццы обеспечивают значительную часть выручки компании, однако их **спрос менее стабилен** по сравнению с категорией AAX. Несмотря на высокую популярность, объёмы продаж данных позиций подвержены более заметным колебаниям, что **требует дополнительного внимания при планировании запасов и маркетинговых активностей.** 
...
**Рекомендуемые действия:**
- провести дополнительный анализ причин колебаний спроса (акции, сезонность, внешние факторы)
- отслеживать периоды повышенного спроса и учитывать их при планировании закупок
- использовать данные позиции в краткосрочных маркетинговых кампаниях и специальных предложениях
- тестировать включение данных пицц в комбо-наборы совместно с лидерами категории AAX

Основной задачей для данной группы является не столько увеличение узнаваемости, сколько повышение предсказуемости спроса и выявление факторов, влияющих на колебания продаж.

<h4 align="center">Перспективные позиции меню (BBX / BBY)</h4>

Данные пиццы демонстрируют **средний вклад в выручку и продажи**, однако обладают потенциалом для дальнейшего роста. В отличие от лидеров категории AA, они ещё не стали ключевыми драйверами бизнеса, но уже доказали свою востребованность среди клиентов.
...
**Рекомендуемые действия:**
- проведение ценовых и продуктовых экспериментов
- анализ отзывов клиентов для выявления факторов, ограничивающих спрос
- размещение в блоках рекомендаций и специальных подборках
- включение в комбо-наборы совместно с лидерами категории AA
- мониторинг динамики продаж после внесения изменений

Основной задачей для данной группы является **поиск точек роста и проверка потенциала перехода отдельных позиций в категорию AA**. При успешных результатах маркетинговых и продуктовых экспериментов данные пиццы могут стать новыми драйверами продаж компании.

<h4 align="center">Кандидаты на оптимизацию ассортимента (BBZ / BC / CB / CC)</h4>

Данные пиццы характеризуются **низким вкладом в выручку либо нестабильным спросом**, что усложняет прогнозирование продаж и снижает эффективность использования ресурсов компании. Они требуют дополнительной оценки с точки зрения их роли в ассортименте и влияния на операционные процессы.
...
**Рекомендуемые действия:**
- провести анализ причин низкого или нестабильного спроса
- проанализировать состав ингредиентов на предмет наличия уникальных и редко используемых компонентов
- рассмотреть возможность оптимизации рецептуры с использованием более популярных ингредиентов
- оценить целесообразность дальнейшего присутствия позиции в ассортименте

Особое внимание рекомендуется уделить пиццам, **содержащим уникальные ингредиенты, которые практически не используются в других позициях меню.** Для перечисленных позиций **рекомендуется провести дополнительный анализ** маржинальности, клиентских предпочтений и фактических затрат на закупку ингредиентов перед принятием решения о сохранении, изменении рецептуры или **выводе продукта из ассортимента.**

**1. Brie Carre Pizza (CC)**
